...
SECRET_KEY = 'django-insecure-zol18ar)hzaa02bcn+4(icmhpz$3l=^%z6axn+k37c_u_z9r_@'
...
MIDDLEWARE = [
    ...
    'chats.middleware.RestrictAccessByTimeMiddleware'  # Custom middleware for restricting access by time
]
